...
select @id,[AccountId], [GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[Quantity]*[PriceBuy] [AmountBuy],[Quantity]*[PriceRetail] [AmountRetail],[Quantity]*[PriceWholeSale] [AmountWholeSale],[Payment],[AmountRetail] - [Payment][Deficit]
from @detail
...
,[Quantity]*[PriceWholeSale] [AmountWholeSale],[Payment],[AmountRetail] - [Payment] [Deficit]
...
,[Deficit]=source.[AmountRetail]-(isnull(target.[Payment],0)+source.[Payment])
...
, [Quantity] * [PriceRetail] ,[Quantity]*[PriceWholeSale] ,[Payment],[AmountRetail]-[Payment] )
...
select  d.[Id]  
	...
	,d.[CustomerName]
		 ...
		 ,max(dd.PriceRetail) PriceRetailSale
