...
INSERT INTO [Accounting].[Document]( [IncludeDate],[PaymentDate],[PartnerOrderNo],[CompanyId],[WareHouseId],[Description],[PaymentTypeId],[ContractId],[SaleNo],Accounting.Document.CreateId,AccountId)
VALUES (@includeDate,@paymentDate,@partnerOrderNo,@companyId,@wareHouseId,@description,@paymentTypeId,@contractId,[Accounting].[SFnNewSaleNo](@userId,@accountCode),@userId,7)
...
VALUES(@id,@paymentid,@accountId, @goodId,@barcodeId,@series,@dateOfProduction,@lastExpirationDate,@TQuantity,@unitId,@TpriceBuy,@TpriceRetail,@TpriceWholeSale,@TQuantity*@TpriceBuy,@TQuantity*@TpriceRetail,@TQuantity*@TpriceWholeSale,@payment, @TQuantity*@TpriceWholeSale,@percent,@userId,getdate())
...
--insert into [Accounting].[Document]( [IncludeDate],[CompanyId],[WareHouseId],[PaymentTypeId],[ContractId],[CreateId])
--values (@includeDate,@companyId,@wareHouseId,@paymentTypeId,@contractId,@userId)

--set @id=SCOPE_IDENTITY();

--insert into [Accounting].[DocumentDetail]([DocumentId],[AccountId],[GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[AmountBuy], [AmountRetail],[AmountWholeSale],[Payment],[Deficit],[CreateId])
--select @id,[AccountId], [GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[Quantity]*[PriceBuy] [AmountBuy],[Quantity]*[PriceRetail] [AmountRetail],[Quantity]*[PriceWholeSale] [AmountWholeSale],[Payment],[AmountWholeSale] - [Payment][Deficit],@userId
--from @detail
...
CREATE PROCEDURE [Accounting].[spDocument]
	...
	@paymentDate datetime =null, 
		@partnerOrderNo nvarchar(200)=null,
		@additionalCost decimal(26,6) =null,
	--@discountBuy NVARCHAR(50)=NULL,
	--@discountRetail NVARCHAR(50)=NULL,
	--@discountWholeSale NVARCHAR(50)=NULL,
	@docTypeId int =null,
@docCertId int =null,
@docSeriesId int=null,
...
,@quantity DECIMAL(26,6),@unitId INT,@priceBuy DECIMAL(26,6),@priceRetail DECIMAL(26,6),@priceWholeSale DECIMAL(26,6),@totalPayment DECIMAL(26,6)=0,@percent NVARCHAR(50)
 ,@costInclude decimal (26,6),@costDeficit decimal (26,6)
...
[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],ISNULL([Percent]+' % Endirim','0')
 ,ISNULL([CostInclude] ,'0' ) ,ISNULL([CostDeficit] ,'0' )
FROM @detail)
OPEN crs
...
--INSERT INTO Accounting.Payment (AccountId,CustomerId,PaymentTypeId,Payment,Deficit)
--VALUES(@accountId,@customerId,isnull(@paymentTypeId,1),@payment,@amountBuy)
...
INSERT INTO [Accounting].[DocumentDetail]([DocumentId],[PaymentId],[AccountId],[GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[AmountBuy], [AmountRetail],[AmountWholeSale],[Payment],[Deficit],[Percent]
 ,[CostInclude],[CostDeficit]
,[CreateId],[CreateDate])
VALUES(@id,@paymentid,@accountId, @goodId,@barcodeId,@series,@dateOfProduction,@lastExpirationDate,@quantity,@unitId,@priceBuy,@priceRetail,@priceWholeSale,@quantity*@priceBuy,@quantity*@priceRetail,@quantity*@priceWholeSale,@payment,@amountBuy,@percent
 ,@costInclude,@costDeficit
,@userId,GETDATE())
...
--if (@stockgoodId=@goodId AND @p1=@priceBuy AND @p2=@priceRetail AND @p3=@priceWholeSale)
--update Accounting.Stock
--SET
--UpdateDate=GETDATE(),
...
--merge [Accounting].[DocumentDetail] target
--using (select [Id],[GoodId],@id [DocumentId],@paymentId [PaymentId],[AccountId],[BarCodeId],[Series],[DateOfProduction]
--,[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale]
--,[Quantity]*[PriceBuy] [AmountBuy],[Quantity]*[PriceRetail] [AmountRetail]
...
--WHEN NOT MATCHED BY target then 
--insert  ( [DocumentId],[PaymentId],[AccountId],[GoodId],[BarCodeId],[Series],[DateOfProduction]
--,[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[AmountBuy]
--,[AmountRetail],[AmountWholeSale],[Payment],[Deficit])
--values (@id,@paymentId,[AccountId],[GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate]
--,[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[Quantity]*[PriceBuy]
...
INSERT INTO Accounting.Payment(AccountId,CustomerId,PaymentTypeId,Deficit,Description,CreateDate) VALUES (@accountId,@customerId,@paymenttypeId,@payment,@description,getdate())
...
--SELECT @id,@paymentid,[AccountId], [GoodId],[BarCodeId],[Series],[DateOfProduction],[LastExpirationDate],[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale],[Quantity]*[PriceBuy] [AmountBuy],[Quantity]*[PriceRetail] [AmountRetail],[Quantity]*[PriceWholeSale] [AmountWholeSale],ISNULL([Payment],0) [Payment],[AmountBuy] [Deficit]
--FROM @detail
...
AS
BEGIN
DECLARE  @goodId INT,@priceBuy decimal(25,5),@priceRetail decimal(25,5),@priceWholeSale decimal(25,5),@newpriceRetail DECIMAL(25,5),@newpriceWholeSale DECIMAL(25,5)

DECLARE crs CURSOR FOR 
(SELECT [GoodId],[PriceBuy],[PriceRetail],[PriceWholeSale],[NewPriceRetail],[NewPriceWholeSale]
FROM @detail)
OPEN crs
FETCH NEXT FROM crs INTO @goodId,@priceBuy,@priceRetail,@priceWholeSale,@newpriceRetail,@newpriceWholeSale
...
WHERE Id=(SELECT MAX(s.Id) FROM Accounting.Stock s WHERE s.GoodId=@goodId)
	...
	INSERT INTO Accounting.LastPrice (StockId,GoodId,PriceBuy,PriceRetail,PriceWholeSale,LastPriceRetail,LastPriceWholeSale,Description,CreateId,CreateDate) 
	VALUES (@stockId,@goodId,@priceBuy,@newpriceRetail,@newpriceWholeSale,@priceRetail,@priceWholeSale,@description,@userId,GETDATE())
...
spSelect:
BEGIN
select  i.FullGoodName,i.Quantity,i.DifferenceQuantity,i.StockQuantity,i.CreateId,i.CreateDate,wh.[Name] WareHouseName FROM Accounting.Inventar i
...
where i.DocumentInventarId=@documentInventarId AND DeleteId IS NULL
 end
...
,[SenderManager],[Received],[ReceivedAddress],[ReceivedManager],[Date],[DeliveryDate],[Description],[CreateId],[DocTypeId],[DocCertId],[DocSeriesId])
...
,@description,@userId,@docTypeId,@docCertId,@docSeriesId);
...
GO
PRINT N'Creating [dbo].[spDocumentInventarSelect]...';
...
using (select Id, AllowShow, AllowCreate, AllowUpdate, AllowDelete, AllowInContainer,AllowRetail,ShowCreate,ShowUpdate,ShowDelete
...
update set Show=source.AllowShow,[Create]=source.AllowCreate,[Update]=source.AllowUpdate,[Delete]=source.AllowDelete,AllowInContainer=source.AllowInContainer,AllowRetail=source.AllowRetail
...
insert (MenuItemId,UserId, [Show], [Create], [Update], [Delete], AllowInContainer,AllowRetail,ShowCreate,ShowUpdate,ShowDelete)
values(Id,@principialId ,AllowShow,AllowCreate,AllowUpdate,AllowDelete,AllowInContainer,AllowRetail,ShowCreate,ShowUpdate,ShowDelete);
...
INSERT INTO [Accounting].[Document]([CompanyId],[WareHouseId],[FromWareHouseId],[ContractId],[Description],[CreateId],[AccountId])
VALUES (@companyId,@warehouseId,@fromWareHouseId,1,@description,@userId,14)
...
----and
----ISNULL(st.quantity,0) + d.Quantity<0 AND st.WarehouseId=@wareHouseGet
...
--INSERT INTO [Accounting].[Document]([CompanyId],[WareHouseId],[Description],[CreateId],[AccountId])
--VALUES (@companyId,@wareHouseId,@description,@userId,14)

--SET @id=SCOPE_IDENTITY();

--DECLARE @totalAmount DECIMAL(26,6)=0, @accountId  INT,@payment DECIMAL(26,6),@amountBuy DECIMAL(26,6),@goodId INT,@barcodeId INT,@series NVARCHAR(200),@dateOfProduction DATETIME,@lastExpirationDate DATETIME
--,@quantity DECIMAL(26,6),@unitId INT,@priceBuy DECIMAL(26,6),@priceRetail DECIMAL(26,6),@priceWholeSale DECIMAL(26,6),@totalPayment DECIMAL(26,6)=0,@percent NVARCHAR(50)
...
--INSERT into [Accounting].[Stock] (DocumentId,WarehouseId,GoodId,CreatId,Series,Quantity,PriceBuy,PrcieRetail,PriceWholeSale,CreateDate)
--VALUES (@id,@wareHouseGet,@goodId,@userId,@series,@TQuantity,@TpriceBuy,@TpriceRetail,@TpriceWholeSale,GETDATE())
...
--INSERT INTO Accounting.Payment (DocumentId,AccountId,CustomerWareHouseId,Payment,Deficit)
--VALUES(@id,@accountId,@wareHouseGet,@payment,@totalPayment)
--SET @paymentid=SCOPE_IDENTITY();
...
--UpdateId=@userId,
--Quantity=0
--WHERE DocumentId=@id AND WarehouseId!=@wareHouseId
...
--FROM Accounting.VwDocumentDetail WHERE DocumentId=@id)
--OPEN crd
--FETCH NEXT FROM crd INTO @payment1 ,@amountBuy1 ,@goodId1,@barcodeId1,@series1 ,@dateOfProduction1 ,@lastExpirationDate1 
--,@quantity1,@unitId1,@priceBuy1,@priceRetail1,@priceWholeSale1
...
--FETCH NEXT FROM crd INTO @payment1 ,@amountBuy1 ,@goodId1,@barcodeId1,@series1 ,@dateOfProduction1 ,@lastExpirationDate1,@quantity1,@unitId1,@priceBuy1,@priceRetail1,@priceWholeSale1
