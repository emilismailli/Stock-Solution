...
GO
PRINT N'Dropping unnamed constraint on [Accounting].[Cash]...';


GO
ALTER TABLE [Accounting].[Cash] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__58FC18A6];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_Cash] ([Id], [CompanyId], [CashName], [Description], [CreateId], [CreateDate], [IsActive])
        SELECT   [Id],
                 [CompanyId],
                 [CashName],
                 [Description],
...
GO
PRINT N'Altering [Accounting].[VwCash]...';


GO
ALTER VIEW [Accounting].[VwCash]
	AS SELECT
...
VALUES (@accountId,@customerId,@paymenttypeId,@expenseId,@cashId,@cashFromId,@payment,@description,getdate())
