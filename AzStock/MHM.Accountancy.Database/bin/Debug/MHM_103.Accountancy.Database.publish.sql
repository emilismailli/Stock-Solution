...
GO
PRINT N'Altering [Accounting].[spCashFromMoney]...';


GO
ALTER PROCEDURE [Accounting].[spCashFromMoney]
	@userId int =null,
	@menuId INT =null
AS
BEGIN
...
END
GO
PRINT N'Altering [Accounting].[spCashToMoney]...';


GO
ALTER PROCEDURE [Accounting].[spCashToMoney]
	@userId int =null,
	@cashId INT =null
AS
