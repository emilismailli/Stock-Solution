...
GO
/*
The type for column Percent in table [Accounting].[DocumentDetail] is currently  NVARCHAR (500) NULL but is being changed to  DECIMAL (26, 6) NULL. Data loss could occur.
*/
...
GO
ALTER TABLE [Accounting].[DocumentDetail] ALTER COLUMN [Percent] DECIMAL (26, 6) NULL;
...
,@quantity DECIMAL(26,6),@unitId INT,@priceBuy DECIMAL(26,6),@priceRetail DECIMAL(26,6),@priceWholeSale DECIMAL(26,6),@totalPayment DECIMAL(26,6)=0,@percent DECIMAL(26, 6) NULL, 
...
,@payment
, @TQuantity*(@TpriceWholeSale -@discountPrice)
, @PriceWholeSale  +  @PriceWholeSale  * @percent *( - 0.01) -- @percent 26.9.2020
,@costInclude
,@costDeficit
,@discountPrice   
,@userId,getdate())
