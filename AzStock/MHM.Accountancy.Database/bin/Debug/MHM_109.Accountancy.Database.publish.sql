...
GO
/*
The type for column Percent in table [Accounting].[DocumentDetail] is currently  NVARCHAR (500) NULL but is being changed to  NVARCHAR (50) NULL. Data loss could occur.
*/

IF EXISTS (select top 1 1 from [Accounting].[DocumentDetail])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping unnamed constraint on [Accounting].[DocumentDetail]...';


GO
ALTER TABLE [Accounting].[DocumentDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__7A92169B];
...
GO
ALTER TABLE [Accounting].[DocumentDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__7B863AD4];


GO
PRINT N'Dropping [Accounting].[spDocumentSale]...';


GO
DROP PROCEDURE [Accounting].[spDocumentSale];


GO
PRINT N'Dropping [Accounting].[UddtSaleGood]...';


GO
DROP TYPE [Accounting].[UddtSaleGood];
...
GO
PRINT N'Starting rebuilding table [Accounting].[DocumentDetail]...';
...
CREATE TABLE [Accounting].[tmp_ms_xx_DocumentDetail] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PKDocumentDetail1] PRIMARY KEY CLUSTERED ([Id] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [Accounting].[DocumentDetail])
    BEGIN
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_DocumentDetail] ON;
        INSERT INTO [Accounting].[tmp_ms_xx_DocumentDetail] ([Id], [TotalId], [PaymentId], [BarcodeId], [DocumentId], [AccountId], [GoodId], [Series], [DateOfProduction], [LastExpirationDate], [Quantity], [UnitId], [PriceBuy], [PriceRetail], [PriceWholeSale], [AmountBuy], [AmountRetail], [AmountWholeSale], [Payment], [Deficit], [Description], [Percent], [DiscountNumber], [DiscountNumberDeficit], [CostInclude], [CostDeficit], [DiscountPrice], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [TotalId],
                 [PaymentId],
                 [BarcodeId],
        ...
        FROM     [Accounting].[DocumentDetail]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_DocumentDetail] OFF;
    END

DROP TABLE [Accounting].[DocumentDetail];

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_DocumentDetail]', N'DocumentDetail';

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_constraint_PKDocumentDetail1]', N'PKDocumentDetail', N'OBJECT';
...
GO
PRINT N'Refreshing [Accounting].[VwCustomerGoodReturn]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwCustomerGoodReturn]';
...
GO
PRINT N'Refreshing [Accounting].[VwCash]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwCash]';
...
GO
PRINT N'Refreshing [Accounting].[VwCashMoney]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwCashMoney]';


GO
PRINT N'Altering [Accounting].[VwPayment]...';


GO
ALTER VIEW [Accounting].[VwPayment]
	AS SELECT 
	p.Id
	,p.ExpenseId
	,ex.ExpenseName
...
GO
PRINT N'Refreshing [Accounting].[VwPaymentIncludeOrder]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwPaymentIncludeOrder]';


GO
PRINT N'Refreshing [Accounting].[VwPaymentTransfer]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwPaymentTransfer]';
...
GO
PRINT N'Refreshing [Accounting].[VwOfflineSale]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwOfflineSale]';
...
GO
PRINT N'Refreshing [Accounting].[VwOfflineSaleDetail]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwOfflineSaleDetail]';
...
GO
PRINT N'Refreshing [Accounting].[VwGoodStockSelect]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwGoodStockSelect]';


GO
PRINT N'Refreshing [Accounting].[VwGoodStockSelectReturn]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwGoodStockSelectReturn]';
...
GO
PRINT N'Altering [Accounting].[VwDocumentDetail]...';


GO
ALTER VIEW [Accounting].[VwDocumentDetail]
	AS SELECT distinct
	 dd.[Id] 
	 ,dd.GoodId StoGoodId
	 ,dd.[DocumentId]
...
GO
PRINT N'Refreshing [Accounting].[IFnBuyPricesByGoodId]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[IFnBuyPricesByGoodId]';
...
GO
PRINT N'Refreshing [Accounting].[IFnPricesByGoodId]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[IFnPricesByGoodId]';
...
,@quantity DECIMAL(26,6),@unitId INT,@priceBuy DECIMAL(26,6),@priceRetail DECIMAL(26,6),@priceWholeSale DECIMAL(26,6),@totalPayment DECIMAL(26,6)=0,@discountPercent nvarchar(50) NULL, @percent nvarchar(50) NULL, 
...
[Quantity],[UnitId],[PriceBuy],[PriceRetail],[PriceWholeSale], ISNULL([DiscountPercent] ,'0' ),ISNULL([Percent]+' % Endirim','0')
...
,@quantity,@unitId,@priceBuy,@priceRetail,@priceWholeSale,@discountPercent,@percent
...
,@payment
, @TQuantity*(@TpriceWholeSale -@discountPrice)
,@PriceWholeSale  +  @PriceWholeSale  * @discountPercent *( - 0.01)
,@percent 
,@costInclude
,@costDeficit
,@discountPrice   
...
GO
PRINT N'Altering [Accounting].[spCash]...';


GO
ALTER PROCEDURE [Accounting].[spCash] 
    @userId int,
    @operationType tinyint,
	@companyId int =null,
...
GO
PRINT N'Altering [Accounting].[spExpense]...';


GO
ALTER PROCEDURE [Accounting].[spExpense] 
@userId int,
@operationType tinyint,
@parentId int=null,
@code varchar(40) =null,
...
GO
PRINT N'Altering [Accounting].[spOfflineSaleDocument]...';


GO
 
ALTER PROCEDURE [Accounting].[spOfflineSaleDocument]
@userId int,
@operationType tinyint,
@id int=null,
@driver nvarchar(200) =null,
...
GO
PRINT N'Refreshing [Accounting].[spChangePrice]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spChangePrice]';
...
GO
PRINT N'Refreshing [Accounting].[spDocumentSaleReturn]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spDocumentSaleReturn]';


GO
PRINT N'Refreshing [Accounting].[spRetailAddTmps]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spRetailAddTmps]';
...
GO
PRINT N'Refreshing [Accounting].[spCustomerCerditor]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spCustomerCerditor]';


GO
PRINT N'Refreshing [Accounting].[spCustomerDebt]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spCustomerDebt]';


GO
PRINT N'Refreshing [Accounting].[spCustomerZero]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spCustomerZero]';


GO
PRINT N'Refreshing [Accounting].[spDebt]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spDebt]';


GO
PRINT N'Refreshing [Accounting].[spPayment]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spPayment]';
