...
,@quantity DECIMAL(26,6),@unitId INT,@priceBuy DECIMAL(26,6),@priceRetail DECIMAL(26,6),@priceWholeSale DECIMAL(26,6),@totalPayment DECIMAL(26,6)=0,@discountPercent DECIMAL(26,6), @percent nvarchar(50) , 
...
,@payment
, @TQuantity*(@TpriceWholeSale -@discountPrice)
,@discountPercent--@PriceWholeSale  +  @PriceWholeSale  * @discountPercent *( - 0.01)
,@percent 
,@costInclude
,@costDeficit
,@discountPrice   
...
FETCH NEXT FROM crs INTO @accountId ,@payment ,@amountWholeSale ,@goodId,@barcodeId,@series ,@dateOfProduction ,@lastExpirationDate,@quantity,@unitId,@priceBuy,@priceRetail,@priceWholeSale,@discountPercent,@percent
 ,@costInclude,@costDeficit,@discountPrice
end
