...
GO
/*
The column [Accounting].[DocumentDetail].[DiscountPercent] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [Accounting].[DocumentDetail] DROP COLUMN [DiscountPercent];
