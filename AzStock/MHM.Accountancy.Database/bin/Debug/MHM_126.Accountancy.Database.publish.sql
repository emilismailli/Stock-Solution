...
GO
PRINT N'Dropping [Accounting].[DF__Cash__CreateDate__1BBE003C]...';


GO
ALTER TABLE [Accounting].[Cash] DROP CONSTRAINT [DF__Cash__CreateDate__1BBE003C];
...
GO
PRINT N'Altering [dbo].[spReportMoney4]...';


GO
ALTER PROC [dbo].[spReportMoney4]
    @userId int,
	@beginDate datetime,
