...
INSERT INTO Accounting.Payment(AccountId,CustomerId,PaymentTypeId,ExpenseId,CashId,Deficit,Description,CreateDate) 
VALUES (@accountId,@customerId,@paymenttypeId,@expenseId,@cashId,@payment,@description,getdate())
...
--INSERT INTO Accounting.Payment(AccountId,CustomerId,PaymentTypeId,ExpenseId,CashId,[CashFromId],Deficit,Description,CreateDate) 
--VALUES (17,@customerId,@paymenttypeId,@expenseId,@cashId,@cashFromId,@payment,@description,getdate())
