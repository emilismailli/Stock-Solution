...
GO
PRINT N'Dropping [Accounting].[spDocument]...';


GO
DROP PROCEDURE [Accounting].[spDocument];


GO
PRINT N'Dropping [Accounting].[UddtIncludeGood]...';


GO
DROP TYPE [Accounting].[UddtIncludeGood];
...
,@quantity,@unitId,@priceBuy,@priceRetail,@priceWholeSale,@percent,@discountPrice
