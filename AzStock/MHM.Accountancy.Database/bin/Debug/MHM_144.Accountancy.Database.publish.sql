...
GO
/*
The column Quantity on table [Accounting].[DocumentDetail] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering [Accounting].[DocumentDetail]...';


GO
ALTER TABLE [Accounting].[DocumentDetail] ALTER COLUMN [Quantity] DECIMAL (26, 6) NOT NULL;
