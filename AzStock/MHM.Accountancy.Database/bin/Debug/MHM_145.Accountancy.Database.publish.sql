...
GO
/*
The column [Accounting].[Payment].[UpdateDate] is being dropped, data loss could occur.

The column [Accounting].[Payment].[UpdateId] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [Accounting].[Payment])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [Accounting].[DF__tmp_ms_xx__Creat__2A0C1F93]...';


GO
ALTER TABLE [Accounting].[Document] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__2A0C1F93];


GO
PRINT N'Dropping [Accounting].[DF__tmp_ms_xx__Inclu__2917FB5A]...';


GO
ALTER TABLE [Accounting].[Document] DROP CONSTRAINT [DF__tmp_ms_xx__Inclu__2917FB5A];


GO
PRINT N'Altering [Accounting].[Payment]...';


GO
ALTER TABLE [Accounting].[Payment] DROP COLUMN [UpdateDate], COLUMN [UpdateId];
...
GO
PRINT N'Altering [Accounting].[VwDocument]...';


GO
ALTER VIEW [Accounting].[VwDocument]
...
GO
PRINT N'Refreshing [Accounting].[VwPayment]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwPayment]';
...
GO
PRINT N'Refreshing [Accounting].[VwIncludeReport]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwIncludeReport]';
...
GO
PRINT N'Refreshing [Accounting].[VwWholeSaleReport]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwWholeSaleReport]';
...
GO
PRINT N'Altering [Accounting].[spDocument]...';


GO
ALTER PROCEDURE [Accounting].[spDocument]
	@userId int ,
...
GO
PRINT N'Altering [Accounting].[spDocumentSale]...';


GO

ALTER proCEDURE [Accounting].[spDocumentSale]
	@userId int ,
	@operationType tinyint = null,
	@id INT = NULL,
	@menuId INT,
...
--end
GO
PRINT N'Altering [dbo].[spTransport]...';


GO
ALTER PROCEDURE [dbo].[spTransport]
	@userId int,
...
GO
PRINT N'Refreshing [Accounting].[spCashTrasnport]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spCashTrasnport]';
...
GO
PRINT N'Refreshing [Accounting].[spPaymentDebt]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spPaymentDebt]';
...
GO
PRINT N'Refreshing [Accounting].[spIncludeReport]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spIncludeReport]';
