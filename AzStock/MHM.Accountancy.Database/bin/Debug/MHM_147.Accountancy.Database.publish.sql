...
GO
PRINT N'Dropping [dbo].[spSetPermissions]...';


GO
DROP PROCEDURE [dbo].[spSetPermissions];


GO
PRINT N'Dropping [dbo].[UddtSetPermissions]...';


GO
DROP TYPE [dbo].[UddtSetPermissions];
...
GO
PRINT N'Starting rebuilding table [dbo].[MenuUserAccess]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_MenuUserAccess] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[MenuUserAccess])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_MenuUserAccess] ([MenuItemId], [UserId], [Show], [Create], [Update], [Delete], [AllowInContainer], [AllowRetail], [ShowCreate], [ShowUpdate], [ShowDelete])
        SELECT [MenuItemId],
               [UserId],
               [Show],
               [Create],
...
DROP TABLE [dbo].[MenuUserAccess];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_MenuUserAccess]', N'MenuUserAccess';
...
GO
PRINT N'Refreshing [dbo].[fnGetAccess]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[fnGetAccess]';
...
update set Show=source.AllowShow,[Create]=source.AllowCreate,[Update]=source.AllowUpdate,[Delete]=source.AllowDelete,AllowInContainer=source.AllowInContainer,AllowRetail=source.AllowRetail,ApplyDocument=source.AllowApplyDocument
...
GO
PRINT N'Altering [dbo].[spUserPermissions]...';


GO
ALTER PROCEDURE [dbo].[spUserPermissions]
	@principalId int
AS
begin
select m.[Id]
...
GO
PRINT N'Refreshing [dbo].[spMenuPermitted]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spMenuPermitted]';
