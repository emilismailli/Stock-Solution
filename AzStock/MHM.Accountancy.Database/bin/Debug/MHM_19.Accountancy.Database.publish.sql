...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__OfflineDe__IsAct__1A3FCC1E];
...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__OfflineDe__Creat__1B33F057];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_OfflineDetail] ([Id], [BarcodeId], [DocumentId], [AccountId], [GoodId], [Quantity], [UnitId], [PriceBuy], [PriceRetail], [PriceWholeSale], [AmountBuy], [AmountRetail], [AmountWholeSale], [Payment], [Deficit], [Description], [Percent], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [BarcodeId],
                 [DocumentId],
                 [AccountId],
...
,od.[Percent]
	...
	left join [Accounting].[Barcode] b on od.BarcodeId=b.Id
GO
...
INSERT INTO [Accounting].[Offline]( [IncludeDate],[PaymentDate],[CompanyId],[WareHouseId],[Description],[PaymentTypeId],[ContractId],[SaleNo],Accounting.Document.CreateId)
VALUES (@includeDate,@paymentDate,@companyId,@wareHouseId,@description,@paymentTypeId,@contractId,[Accounting].[SFnNewSaleNo](@userId,@accountCode),@userId)
...
SET @id=SCOPE_IDENTITY();
   ...
   ,[GoodId]
   ,[BarCodeId]
   ,[Series],[DateOfProduction],[LastExpirationDate]
   ,[Quantity]
   ,[UnitId]
   ,[PriceBuy] 
   ,[PriceWholeSale]
