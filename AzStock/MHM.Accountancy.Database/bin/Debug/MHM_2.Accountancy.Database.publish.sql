...
IF EXISTS (select top 1 1 from [Accounting].[Barcode])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [Accounting].[DF__Barcode__CreateD__119F9925]...';


GO
ALTER TABLE [Accounting].[Barcode] DROP CONSTRAINT [DF__Barcode__CreateD__119F9925];


GO
PRINT N'Altering [Accounting].[Barcode]...';


GO
ALTER TABLE [Accounting].[Barcode] ALTER COLUMN [Barcode] VARCHAR (200) NULL;
...
GO
PRINT N'Refreshing [Accounting].[IFnBarcodeGood]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[IFnBarcodeGood]';
