...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__20ECC9AD];
...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__21E0EDE6];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_OfflineDetail] ([Id], [BarcodeId], [DocumentId], [AccountId], [GoodId], [Series], [DateOfProduction], [LastExpirationDate], [Quantity], [UnitId], [PriceBuy], [PriceRetail], [PriceWholeSale], [AmountBuy], [AmountRetail], [AmountWholeSale], [Payment], [Deficit], [Description], [Percent], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [BarcodeId],
                 [DocumentId],
                 [AccountId],
...
ALTER VIEW [Accounting].[VwOfflineDetail]
	...
	FROM [Accounting].[OfflineDetail] dd
