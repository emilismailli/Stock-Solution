...
INSERT INTO [Accounting].[Document]( [IncludeDate],[PaymentDate],[CompanyId],[WareHouseId],[Description],[PaymentTypeId],[ContractId],[SaleNo],Accounting.Document.CreateId)
...
SET @id=SCOPE_IDENTITY();
   ...
   INSERT INTO [Accounting].DocumentDetail
   ( 
     [DocumentId]  
