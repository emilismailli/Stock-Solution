...
GO
ALTER TABLE [Accounting].[Logistic] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__03C67B1A];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_Logistic] ([Id], [Driver], [Fin], [Transportation], [Cart], [Sender], [SenderAddress], [SenderManager], [Received], [ReceivedAddress], [ReceivedManager], [Date], [DeliveryDate], [Description], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly], [DocTypeId], [DocCertId], [DocSeriesId])
        SELECT   [Id],
                 [Driver],
                 [Fin],
                 [Transportation],
