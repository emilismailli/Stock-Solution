...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__31233176];
...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__321755AF];
...
GO
PRINT N'Dropping [Accounting].[spLogisticDocument]...';


GO
DROP PROCEDURE [Accounting].[spLogisticDocument];


GO
PRINT N'Dropping [Accounting].[UddtLogisticDetail]...';


GO
DROP TYPE [Accounting].[UddtLogisticDetail];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_OfflineDetail] ([Id], [LogisticId], [BarcodeId], [GoodId], [Quantity], [UnitId], [Description], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [LogisticId],
                 [BarcodeId],
                 [GoodId],
