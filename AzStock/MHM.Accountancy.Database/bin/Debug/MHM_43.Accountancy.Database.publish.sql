...
GO
ALTER TABLE [Accounting].[OfflineDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__37D02F05];
...
GO
ALTER TABLE [Accounting].[OfflineDetail] ALTER COLUMN [IsActive] BIT NULL;
