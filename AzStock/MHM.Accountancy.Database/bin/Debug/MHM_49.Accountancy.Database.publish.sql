...
GO
PRINT N'Dropping unnamed constraint on [Accounting].[OfflineSaleDetail]...';


GO
ALTER TABLE [Accounting].[OfflineSaleDetail] DROP CONSTRAINT [DF__OfflineSa__IsAct__60D24498];
...
GO
ALTER TABLE [Accounting].[OfflineSaleDetail] DROP CONSTRAINT [DF__OfflineSa__Creat__61C668D1];


GO
PRINT N'Dropping unnamed constraint on [Accounting].[LogisticDetail]...';


GO
ALTER TABLE [Accounting].[LogisticDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__5A254709];
...
GO
ALTER TABLE [Accounting].[LogisticDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__5B196B42];


GO
PRINT N'Unbinding constraint [Accounting].[PKLogisticDetail]...';


GO
EXECUTE sp_rename N'[Accounting].[PKLogisticDetail]', N'tmp_ms_xx_constraint_unbind_PKLogisticDetail', N'OBJECT';


GO
PRINT N'Unbinding constraint [Accounting].[PKOfflineSaleDetail]...';


GO
EXECUTE sp_rename N'[Accounting].[PKOfflineSaleDetail]', N'tmp_ms_xx_constraint_unbind_PKOfflineSaleDetail', N'OBJECT';


GO
PRINT N'Dropping [Accounting].[spOfflineSaleDocument]...';


GO
DROP PROCEDURE [Accounting].[spOfflineSaleDocument];


GO
PRINT N'Dropping [Accounting].[UddtOfflineSaleDetail]...';


GO
DROP TYPE [Accounting].[UddtOfflineSaleDetail];
...
GO
PRINT N'Starting rebuilding table [Accounting].[OfflineSaleDetail]...';
...
CREATE TABLE [Accounting].[tmp_ms_xx_OfflineSaleDetail] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PKOfflineSaleDetail1] PRIMARY KEY CLUSTERED ([Id] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [Accounting].[OfflineSaleDetail])
    BEGIN
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_OfflineSaleDetail] ON;
        INSERT INTO [Accounting].[tmp_ms_xx_OfflineSaleDetail] ([Id], [LogisticId], [BarcodeId], [GoodId], [Quantity], [UnitId], [Description], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [LogisticId],
                 [BarcodeId],
                 [GoodId],
        ...
        FROM     [Accounting].[OfflineSaleDetail]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_OfflineSaleDetail] OFF;
    END

DROP TABLE [Accounting].[OfflineSaleDetail];

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_OfflineSaleDetail]', N'OfflineSaleDetail';

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_constraint_PKOfflineSaleDetail1]', N'PKOfflineSaleDetail', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [Accounting].[LogisticDetail]...';
...
CREATE TABLE [Accounting].[tmp_ms_xx_LogisticDetail] (
    [Id]          INT             IDENTITY (1, 1) NOT NULL,
    [LogisticId]  INT             NULL,
    [BarcodeId]   INT             NULL,
    [GoodId]      INT             NULL,
    ...
    [DeleteDate]  DATETIME        NULL,
    [ReadOnly]    DATETIME        NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PKLogisticDetail1] PRIMARY KEY CLUSTERED ([Id] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [Accounting].[LogisticDetail])
    BEGIN
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_LogisticDetail] ON;
        INSERT INTO [Accounting].[tmp_ms_xx_LogisticDetail] ([Id], [LogisticId], [BarcodeId], [GoodId], [Quantity], [UnitId], [Description], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [LogisticId],
                 [BarcodeId],
                 [GoodId],
        ...
        FROM     [Accounting].[LogisticDetail]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [Accounting].[tmp_ms_xx_LogisticDetail] OFF;
    END

DROP TABLE [Accounting].[LogisticDetail];

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_LogisticDetail]', N'LogisticDetail';

EXECUTE sp_rename N'[Accounting].[tmp_ms_xx_constraint_PKLogisticDetail1]', N'PKLogisticDetail', N'OBJECT';
...
GO
PRINT N'Refreshing [Accounting].[VwOffline]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwOffline]';
...
GO
PRINT N'Refreshing [Accounting].[VwOfflineDetail]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[VwOfflineDetail]';
...
GO
PRINT N'Altering [Accounting].[VwOfflineSaleDetail]...';


GO
ALTER VIEW [Accounting].[VwOfflineSaleDetail]
	AS SELECT
...
GO
PRINT N'Refreshing [Accounting].[IFnOfflineSaleDetail]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[IFnOfflineSaleDetail]';
...
GO
PRINT N'Refreshing [Accounting].[IFnLogisticDetail]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[IFnLogisticDetail]';
...
,@description,@userId,@docTypeId,@docCertId,@docSeriesId,@companyId,@wareHouseId,@paymentTypeId,@contractId);
 ...
 insert into [Accounting].[OfflineSaleDetail]([LogisticId],[BarcodeId],[GoodId],[Quantity],[PriceWholeSale],[AmountWholeSale],[UnitId],[Description])
                                    select @id,[BarcodeId],[GoodId],[Quantity],[PriceWholeSale],[AmountWholeSale],[UnitId],[Description] from @details
	if @@TRANCOUNT>0
	COMMIT;
...
GO
PRINT N'Refreshing [Accounting].[spOfflineDocument]...';


GO
EXECUTE sp_refreshsqlmodule N'[Accounting].[spOfflineDocument]';
