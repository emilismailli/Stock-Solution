...
GO
ALTER TABLE [Accounting].[OfflineSaleDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__69678A99];
...
GO
ALTER TABLE [Accounting].[OfflineSaleDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__6A5BAED2];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_OfflineSaleDetail] ([Id], [LogisticId], [BarcodeId], [GoodId], [Quantity], [PriceWholeSale], [AmountWholeSale], [UnitId], [Description], [IsActive], [SaleNo], [CreateId], [CreateDate], [UpdateId], [UpdateDate], [DeleteId], [DeleteDate], [ReadOnly])
        SELECT   [Id],
                 [LogisticId],
                 [BarcodeId],
                 [GoodId],
