...
DEALLOCATE css
 ...
 ,[CostInclude],[CostDeficit]
 ,[CreateId],[CreateDate])
VALUES(@id,@paymentid,@accountId, @goodId,@barcodeId,@series,@dateOfProduction,@lastExpirationDate,@TQuantity,@unitId,@TpriceBuy,@TpriceRetail,@TpriceWholeSale,@TQuantity*@TpriceBuy,@TQuantity*@TpriceRetail,@TQuantity*@TpriceWholeSale,@payment, @TQuantity*@TpriceWholeSale,@percent ,@costInclude,@costDeficit
,@userId,getdate())
...
select  d.[Id]  
	...
	,d.[AdditionalCost]
         ...
         ,max(dd.AmountRetail) AmountRetail
         ,max(dd.AmountWholeSale) AmountWholeSale
		 ,max(dd.PriceBuy) PriceBuy
		 ,max(dd.PriceRetail) PriceRetail
		 ,max(dd.PriceWholeSale) PriceWholeSale
	     ,max(dd.Payment) Payment
	     ,max(dd.Deficit) Deficit
