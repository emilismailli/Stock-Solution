...
GO
ALTER TABLE [Accounting].[DocumentDetail] DROP CONSTRAINT [DF__tmp_ms_xx__IsAct__6DA22FD1];
...
GO
ALTER TABLE [Accounting].[DocumentDetail] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__6E96540A];
...
DEALLOCATE css
 ...
 ,[CostInclude],[CostDeficit],[DiscountPrice]
 ,[CreateId],[CreateDate])
VALUES(@id,@paymentid,@accountId, @goodId,@barcodeId,@series,@dateOfProduction,@lastExpirationDate,@TQuantity,@unitId,@TpriceBuy,@TpriceRetail,@TpriceWholeSale,@TQuantity*@TpriceBuy,@TQuantity*@TpriceRetail,@TQuantity*@TpriceWholeSale,@payment, @TQuantity*@TpriceWholeSale,@percent ,@costInclude,@costDeficit,@TpriceWholeSale-@discountPrice   
,@userId,getdate())
