/*
Deployment script for SomarTest
...
GO
:setvar DatabaseName "SomarTest"
:setvar DefaultFilePrefix "SomarTest"
...
GO
PRINT N'Rename refactoring operation with key 953c4cc8-13b1-4512-ae65-9eb1ffb252af is skipped, element [dbo].[Account].[Parent] (SqlSimpleColumn) will not be renamed to ParentId';


GO
PRINT N'Rename refactoring operation with key 36c7d39b-5760-4c5c-9f58-40661a15da79 is skipped, element [dbo].[Company].[CompanyNama] (SqlSimpleColumn) will not be renamed to CompanyName';


GO
PRINT N'Rename refactoring operation with key a281162f-106f-45d3-a768-2cf94ee047a0 is skipped, element [dbo].[Company].[Company] (SqlSimpleColumn) will not be renamed to CompanyLeader';


GO
PRINT N'Rename refactoring operation with key 55237ec5-faa4-43d9-8d83-d348a0fffc1e is skipped, element [dbo].[Company].[Operator] (SqlSimpleColumn) will not be renamed to OperatorBank';


GO
PRINT N'Rename refactoring operation with key f28d4de7-1990-4fc3-a002-a2f5a533121c is skipped, element [dbo].[Company].[BnakSwift] (SqlSimpleColumn) will not be renamed to BankSwift';


GO
PRINT N'Rename refactoring operation with key 22ba3c40-b025-41f8-bd8f-dfec8c58f04a is skipped, element [Accounting].[Good].[Currency] (SqlSimpleColumn) will not be renamed to CurrencyId';


GO
PRINT N'Rename refactoring operation with key 319b1157-463c-4c6b-89e4-e71152e5bcca is skipped, element [Accounting].[Contract].[OperationType] (SqlSimpleColumn) will not be renamed to OperationTypeId';


GO
PRINT N'Rename refactoring operation with key cd65fa4a-f722-4b89-96d6-154977cb0b62 is skipped, element [dbo].[UserRegistration].[bIRTHoFdATE] (SqlSimpleColumn) will not be renamed to BirthOfDate';


GO
PRINT N'Rename refactoring operation with key f935294a-90e9-4fef-ac5a-d0fd16471a30 is skipped, element [dbo].[User].[Role] (SqlSimpleColumn) will not be renamed to RoleId';


GO
PRINT N'Rename refactoring operation with key 87d4001e-5f3b-4c7a-9660-063294d933de is skipped, element [Accounting].[Payment].[CustomerId] (SqlSimpleColumn) will not be renamed to CustomerName';


GO
PRINT N'Rename refactoring operation with key 8caae87c-c859-45b0-a41b-72f5ab788873 is skipped, element [Accounting].[Payment].[PaymentType] (SqlSimpleColumn) will not be renamed to PaymentTypeId';


GO
PRINT N'Rename refactoring operation with key 7855e3eb-a43d-45c1-b971-078460816b84 is skipped, element [Accounting].[Payment].[CustomerWareHouse] (SqlSimpleColumn) will not be renamed to CustomerWareHouseId';


GO
PRINT N'Rename refactoring operation with key a96ff823-12e8-4f24-9394-e4de8140b5e1, 0ff5c5bf-cd6a-4033-880f-410c758f1a89 is skipped, element [dbo].[MenuUserAccess].[Show] (SqlSimpleColumn) will not be renamed to ShowCreate';


GO
PRINT N'Rename refactoring operation with key fc409f77-c0b8-4752-a31b-e52167cbd5a1 is skipped, element [dbo].[MenuUserAccess].[ShowEdit] (SqlSimpleColumn) will not be renamed to ShowUpdate';
