...
-- ,[CostInclude],[CostDeficit],[DiscountPrice]
-- ,[CreateId],[CreateDate])  
--VALUES(@id,@paymentid,@accountId, @goodId,@barcodeId,@series,@dateOfProduction,@lastExpirationDate,@TQuantity,@unitId,@TpriceBuy,@TpriceRetail,@TpriceWholeSale -@discountPrice  
--,@TQuantity*@TpriceBuy
--,@TQuantity*@TpriceRetail, @TQuantity*(@TpriceWholeSale-@discountPrice),@payment,@percent ,@costInclude,@costDeficit,@discountPrice   
--,@userId,getdate())
