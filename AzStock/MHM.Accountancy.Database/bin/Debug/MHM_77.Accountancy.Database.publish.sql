...
GO
PRINT N'Creating [Accounting].[VwGoodStockSelectRetuurn]...';


GO
 

create VIEW [Accounting].[VwGoodStockSelectRetuurn]
	AS
...
GO
PRINT N'Altering [Accounting].[spDocumentReturnInclude]...';


GO
ALTER PROCEDURE [Accounting].[spDocumentReturnInclude]
	@userId int ,
	@operationType tinyint = null,
	@id INT = NULL,
	@menuId INT,
...
DEALLOCATE css
 ...
 ,[PriceWholeSale]
 ,[AmountBuy]
 ,[AmountRetail],[AmountWholeSale] ,[Payment] ,[Deficit],[CostInclude]
 ,[CostDeficit]
 ,[DiscountPrice]
 ,[CreateId]
 ,[CreateDate])
