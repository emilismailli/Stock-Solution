...
GO
/*
The column [Accounting].[Cash].[Name] is being dropped, data loss could occur.

The column [Accounting].[Cash].[CashName] on table [Accounting].[Cash] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_Cash] ([Id], [CompanyId], [WareHouseId], [Description])
        SELECT   [Id],
                 [CompanyId],
                 [WareHouseId],
                 [Description]
