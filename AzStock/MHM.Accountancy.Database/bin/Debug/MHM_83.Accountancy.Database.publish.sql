...
GO
/*
The column [Accounting].[Expense].[CreateId] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Altering [Accounting].[Expense]...';


GO
ALTER TABLE [Accounting].[Expense] DROP COLUMN [CreateId];
