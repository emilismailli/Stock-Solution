...
GO
ALTER TABLE [Accounting].[Payment] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__218BE82B];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_Payment] ([Id], [AccountId], [CustomerId], [CustomerWareHouseId], [DocumentId], [PaymentTypeId], [Payment], [Deficit], [Description], [Percent], [CreateDate])
        SELECT   [Id],
                 [AccountId],
                 [CustomerId],
                 [CustomerWareHouseId],
...
spAdd:
begin
insert into [Accounting].[Cash] (CompanyId,[CashName],WareHouseId,  [Description],CreateId)
values(@companyId,@cashName,@wareHouseId, @description,@userId);
