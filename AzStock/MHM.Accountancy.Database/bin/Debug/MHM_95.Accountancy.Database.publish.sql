...
GO
ALTER TABLE [Accounting].[Payment] DROP CONSTRAINT [DF__tmp_ms_xx__Creat__6A26A4A8];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Accounting].[tmp_ms_xx_Payment] ([Id], [CashId], [ExpenseId], [AccountId], [CustomerId], [CustomerWareHouseId], [DocumentId], [PaymentTypeId], [Payment], [Deficit], [Description], [Percent], [CreateDate])
        SELECT   [Id],
                 [CashId],
                 [ExpenseId],
                 [AccountId],
...
GO
PRINT N'Altering [Accounting].[VwCashMoney]...';


GO
ALTER VIEW [Accounting].[VwCashMoney]
	AS SELECT 
    ca.CashName
...
GO
PRINT N'Creating [dbo].[spCashSelect]...';


GO
CREATE PROCEDURE [dbo].[spCashSelect]
	@userId int null,
	@menuId INT null
AS
BEGIN
