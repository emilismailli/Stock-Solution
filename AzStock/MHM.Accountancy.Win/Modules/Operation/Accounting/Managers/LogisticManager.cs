...
{
    partial class LogisticManager : MHMManager, IManager
    {
        LogisticManager(IContainer container, int managerId)
        ...
        {
            {
                ...
                MHMContainer.CurrentUser.ExecuteProcedure(dataSet.VwLogistic, "[Accounting].[spLogisticDocument]", Parameters, true, System.Data.CommandType.StoredProcedure);
